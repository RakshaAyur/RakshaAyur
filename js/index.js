...
class UI{
    nav_bar(){
        let menu=document.querySelector(".menu")
            ...
            <li class="nav-item"><a href="index.html#NaturalOils" class="nav-link text-white">Natural Oils</a></li>
            <li class="nav-item"><a href="index.html#DryFruists" class="nav-link text-white">Dry Fruits</a></li>
